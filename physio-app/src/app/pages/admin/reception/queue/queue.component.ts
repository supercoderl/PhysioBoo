...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-8">
      ...
      <div class="mb-8">
        <div class="bg-white rounded-3xl shadow-2xl p-12 border-4 border-blue-500">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="text-3xl font-bold text-gray-800">NEXT</h3>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="text-3xl font-bold text-gray-800">WAITING</h3>
          </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl p-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            <div>
              <p class="text-2xl font-semibold text-gray-800">Please wait for your number</p>
              <p class="text-lg text-gray-600">Check the counter location when called</p>
            </div>
          </div>
          <div class="text-right">
            <p class="text-lg text-gray-600">{{ currentTime }}</p>
            <p class="text-2xl font-bold text-blue-600">{{ currentDate }}</p>
          </div>
        </div>
      </div>

      <!-- Scrolling Announcement -->
      <div class="mt-6 bg-red-600 rounded-2xl shadow-xl p-4 overflow-hidden">
...
export class AdminQueueComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.timeInterval = setInterval(() => {
            this.updateTime();
            // Fetch queue updates from API
            // this.fetchQueueUpdates();
        }, 1000);
    }
