            ...
            <div class="flex flex-col h-full bg-surface relative">
                ...
                <div class="flex-1 overflow-y-auto bg-surface" custom-scrollbar [formGroup]="form">
                        ...
                        <div class="flex gap-5">
                            <div class="flex-1 space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <boo-input label="Code" formControlName="code" placeholder="Ex: BV-01"></boo-input>
                                    <div>
                                        <boo-select 
                                            label="Select Type"
                    ...
                    <div class="p-6 pb-10">
                        ...
                        <div class="space-y-4">
                            <boo-textarea label="Network Hospitals (JSON or Text)" formControlName="networkHospitals" placeholder="List of hospitals..."></boo-textarea>
