...
@Component({
    ...
    standalone: true,
    imports: [SharedModule, BooIconComponent, BooSelectComponent],
    template: `
    <div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div class="max-w-5xl mx-auto">
        ...
        <div *ngIf="!loadingSrv.isLoading('handover') && cards.length === 0" class="bg-surface rounded-lg shadow-md p-12 flex flex-col items-center justify-center text-center">
        ...
        <div *ngIf="!loadingSrv.isLoading('handover') && cards.length > 0" class="space-y-4">
...
export class AdminNursingHandoverComponent implements OnInit {
    ...
    load(): void {
        ...
        this.srv.getHandoverCards(this.outgoingShift).subscribe({
            ...
            error: () => this.loadingSrv.setLoading('handover', false),
        });
    }
