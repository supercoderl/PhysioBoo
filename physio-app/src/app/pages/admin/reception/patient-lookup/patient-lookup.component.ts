...
import { AdminBookingTableCardComponent } from "../../../../components/layout/admin/booking/patient-lookup-table-card.component";
...
@Component({
    ...
    <admin-content-header>
      <!-- Start Page Header -->
      <div
        class="flex items-center md:flex-column gap-2 pb-3 mb-2 border-1 border-bottom"
      >
        <div class="flex-1">
          <h4 class="text-xl font-semibold mb-0">Patient Lookup</h4>
        </div>
        <div class="text-right flex">
          ...
          <div class="relative me-1">
            <boo-button-admin
              ...
              buttonClass="h-full"
              [fontSize]="15"
              [dropdown]="menuExportRef"
            >
              <span>Export</span>
              <boo-icon name="chevron-down" />
            </boo-button-admin>
            <ng-template #menuExportRef>
              ...
              >
                <li>
                  <a
                    class="block text-[14px] text-primary bg-transparent rounded-[4.8px] px-3.75 py-1.625"
                    href="#"
                    >Download as PDF</a
                  >
                </li>
      ...
      <div class="flex items-center justify-between flex-wrap">
        ...
        <div
          class="flex table-dropdown right-content items-center flex-wrap row-gap-3"
        >
      ...
      <div class="mt-2">
        <admin-patient-lookup-table-card />
      </div>
    </admin-content-header>
    `
})
