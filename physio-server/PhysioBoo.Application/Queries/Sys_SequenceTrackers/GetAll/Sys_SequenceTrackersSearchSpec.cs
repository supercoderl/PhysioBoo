...
{
    public sealed class Sys_SequenceTrackersSearchSpec : Specification<Sys_SequenceTracker>
    {
        public Sys_SequenceTrackersSearchSpec(
            GetAllSys_SequenceTrackersQuery q,
