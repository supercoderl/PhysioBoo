...
{
    /// <inheritdoc />
    public partial class AddEmailNormalizedUser : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // First ensure the normalize_gmail_email function exists
            migrationBuilder.Sql(@"
                CREATE OR REPLACE FUNCTION normalize_gmail_email(email_input TEXT)
                RETURNS TEXT
                LANGUAGE SQL
                IMMUTABLE
                PARALLEL SAFE
                AS $$
                    SELECT CASE 
                        WHEN LOWER(email_input) LIKE '%@gmail.com' OR LOWER(email_input) LIKE '%@googlemail.com' THEN
                            REPLACE(SPLIT_PART(LOWER(email_input), '@', 1), '.', '') || '@gmail.com'
                        ELSE 
                            LOWER(email_input)
                    END;
                $$;
            ...
            migrationBuilder.AddColumn<string>(
                ...
                maxLength: 255,
                nullable: true,
                computedColumnSql: @"normalize_gmail_email(""Email"")",
                stored: true);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS normalize_gmail_email(TEXT);");
