...
@Component({
  selector: 'common-category-lab-test-category-table-card',
  standalone: true,
  imports: [
    SharedModule,
    ...
    <div class="bg-surface rounded-[6px] border border-gray-200 h-full overflow-hidden">
      ...
      >  
        ...
        <ng-template appColumnDef="department" headerLabel="Department" headerClass="text-left" let-item>
          <div class="text-sm">{{ item.department }}</div>
        </ng-template>
...
export class CommonCategoryLabTestCategoryTableCardComponent {
  // #region Inputs, Outputs, Properties
  @Input() data: PaginationData<LabTestCategory> | null = null;
