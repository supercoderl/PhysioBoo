...
@Component({
  ...
  template: `
    <div class="w-full inline-flex flex-col relative min-w-0 p-0 m-0 border-0">
      ...
      >
        <div
          class="text-[13px] leading-[1.43] text-[#1F232B] inline-flex items-start w-full relative rounded-[8px] min-h-8 p-2 h-auto bg-surface border border-solid border-[#0000003b]"
        >
