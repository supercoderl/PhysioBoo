      ...
      <div class="z-10 flex h-full flex-auto flex-col">
        <div class="flex flex-1 z-[2] min-w-0 h-full bg-[#F6F7F8] absolute inset-0 overflow-hidden">
          <div class="relative mx-0 border-0 w-[320px] max-w-[320px] overflow-hidden bg-transparent flex-0">
            <div class="w-full relative bg-[#F6F7F8] text-[#1F232B] min-w-full h-full overflow-y-auto flex flex-col top-0 left-0">
              <div class="relative">
                <div class="lg:min-w-0 flex flex-col max-h-full bg-[#F6F7F8]">
                  <div class="flex items-center justify-between p-4">
                    <p class="tracking-tight font-extrabold leading-none text-[24px] m-0">
                      Categories
                    </p>
                  </div>
                  <div class="navigation px-3">
                    ...
                    >
                      <boo-icon [name]="category.icon"></boo-icon>
                      <div class="flex min-w-0 flex-auto flex-col items-start gap-1">
                        <p class="leading-none truncate max-w-full m-0 text-[13px]">
                          {{category.name}}
                        </p>
                        <p class="leading-none text-[11px] truncate max-w-full m-0 text-[#4B5563]">
                            anage your public profile and private information
                        </p>
                      </div>
                    </a>
                  </div>
          ...
          <div class="pt-0.5 pl-0.5 flex flex-col w-full z-[9999]">
            <div 
              class="ps bg-white relative flex flex-col flex-1 min-h-0 overscroll-contain h-screen shadow-card"
