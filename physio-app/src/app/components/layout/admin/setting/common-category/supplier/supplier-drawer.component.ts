        ...
        >
            <div class="flex flex-col h-full bg-surface relative">
                ...
                <div class="flex-1 overflow-y-auto bg-surface" custom-scrollbar [formGroup]="form">
                    <boo-json-input [targetForm]="form"></boo-json-input>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <boo-input label="Supplier Code" formControlName="supplierCode" placeholder="Ex: SUP-001"></boo-input>
                        </div>
                        <div>
                            <boo-select 
                                label="Select Type"
            ...
            .subscribe(_res => {
                if (_res.success) {
                    this.form.patchValue({
                        ...
                        supplierCode: _res.data?.supplierCode,
